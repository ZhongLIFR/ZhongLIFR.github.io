...
**Zhong Li** is a postdoc researcher on AI4Math (working with Prof.dr. [Zaiwen Wen](https://scholar.google.com/citations?user=QfxrxDoAAAAJ&hl=en)). He is also a guest researcher in Computer Science at **Leiden University**, affiliated with the [EDA Lab](https://eda.liacs.nl/). He completed his PhD under the supervision of Dr. [Matthijs van Leeuwen](https://scholar.google.com/citations?user=GGLwU28AAAAJ&hl=en&oi=ao) (daily supervisor and promotor) and Prof. Dr. [Thomas Bäck](https://scholar.google.com/citations?hl=en&user=x7LEID0AAAAJ) (promotor). In 2024, he was a visiting PhD researcher at the [DAML](https://www.cs.cit.tum.de/en/daml/home/) group, Technical University of Munich, supervised by Prof. Dr. [Stephan Günnemann](https://scholar.google.de/citations?user=npqoAWwAAAAJ&hl=en).
...
- **2026.06**: 🔥🔥 One research paper is accepted by DMKD: [Graph Neural Networks based Log Anomaly Detection and Explanationk](http://arxiv.org/abs/2307.00527)
